...
namespace HRLeaveManagementPersistence.Migrations
{
    ...
    [Migration("20240318102356_InitialMigration")]
            ...
            modelBuilder.Entity("HRLeaveManagement.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2024, 3, 18, 11, 23, 55, 870, DateTimeKind.Local).AddTicks(698),
                            DateModified = new DateTime(2024, 3, 18, 11, 23, 55, 870, DateTimeKind.Local).AddTicks(754),
                            DefaultDays = 10,
                            Name = "Vacation"
                        });
                });
